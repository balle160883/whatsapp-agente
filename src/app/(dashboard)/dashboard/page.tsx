          ...
          >
            ...
            <div className="card">
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "1.25rem" }}>
                ...
                <span className="badge badge-info" style={{ marginLeft: "auto" }}>14 días</span>
              </div>
            ...
            <div className="card">
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.25rem" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                  ...
                  <span style={{ fontWeight: 600, fontSize: "0.9375rem" }}>Conversaciones recientes</span>
                </div>
                <Link href="/conversaciones" className="btn btn-ghost btn-sm" style={{ fontSize: "0.75rem" }}>

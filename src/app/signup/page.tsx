    ...
    >
      <div className="animate-fade-in" style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <p
            style={{ color: 'var(--color-text-muted)', marginTop: '0.5rem', fontSize: '0.875rem' }}
          >
        ...
        <div className="card" style={{ padding: '2rem' }}>
          {success ? (
            ...
            >
              <div>
                <label htmlFor="orgName" style={fieldStyle}>
              ...
              <div>
                <label htmlFor="name" style={fieldStyle}>
                  Tu nombre
                </label>
                <div style={{ position: 'relative' }}>
              ...
              <div>
                <label htmlFor="signup-email" style={fieldStyle}>
                  Correo electrónico
                </label>
                <div style={{ position: 'relative' }}>
              ...
              <div>
                <label htmlFor="signup-password" style={fieldStyle}>
                  Contraseña
                </label>
                <div style={{ position: 'relative' }}>

...
export const AGENT_TOOLS: Tool[] = [
    ...
    parameters: {
      ...
      properties: {
        ...
        days_ahead: {
          type: "number",
          description:
            "Cuántos días hacia adelante buscar disponibilidad. Por defecto 7.",
        },
      },
      required: ["service"],
    },
  },
  {
    ...
    description:
      "Reserva una cita en el calendario para el cliente con los datos proporcionados.",
    parameters: {
      type: "object",
      properties: {
        full_name: {
        ...
        is_new_patient: {
          type: "boolean",
          description:
            "Indica si el cliente es nuevo (true) o ya es cliente existente (false).",
        },
      },
  ...
  },
  {
    ...
    description:
      "Guarda o actualiza la información de contacto del cliente en el sistema.",
    parameters: {
      type: "object",
      properties: {
        full_name: {
    ...
    parameters: {
      ...
      properties: {
        reason: {
          type: "string",
          description:
            "Razón por la que se solicita la transferencia a un humano.",
        },
      },
      required: ["reason"],
    },
